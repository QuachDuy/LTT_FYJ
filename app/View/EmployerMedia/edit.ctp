...
<?php echo $this->Form->create('EmployerMedia'); ?>
	<fieldset>
		<legend><?php echo __('Edit Employer Media'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('EmployerMedia.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('EmployerMedia.id'))); ?></li>
